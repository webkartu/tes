    ...
    <header id="header_duel">
        <nav>
          <ul>
            ...
            <li><a class="animate__animated animate__fadeInUp" href="ownertambah.php?user_name=<?php echo $yang_login ?>"  id="hal-duelhome"style="text-transform: uppercase;"><?php echo $yang_login ?></a></li>
            <li><a class= "animate__animated animate__fadeInUp"href="koleksi.php">Kembali</a></li>
          </ul>
        </nav>
      </header>
      <main>
  ...
  <?php 
    while($row = mysqli_fetch_assoc($result)) { ?>
      <div class="image_container_koleksi">
        <img class="animate__animated animate__fadeInUp" src="<?php echo $row['link']?>" alt="<?php echo $row['nama_kartu']?>"overall="<?php echo $row['overall']?>" idKartu="<?php echo $row['id']?>">
...
const dataInputOverall = document.querySelector('input[name="dataOvr"]');
// const dataInputLink = document.querySelector('input[name="linkKartu"]');
dataInput.value=alt;
dataInputOverall.value = overall;
// dataInputLink.value = srcKartu;
