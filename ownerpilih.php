    ...
    <header id="header_duel">
        <nav>
          <ul>
            ...
            <li><a class= "animate__animated animate__fadeInUp"href="ownerhome.php">Lihat Komentar</a></li>
            <li><a class= "animate__animated animate__fadeInUp"href="ownerpilih.php" id="hal-history">Tambah Data</a></li>
          </ul>
        </nav>
      </header>
      <main>
        ...
        <td class="tombolhapus"> 
            <a href="ownertambah.php?user_name=<?php echo $row1["username"]?>">PILIH</a>
        </td>
